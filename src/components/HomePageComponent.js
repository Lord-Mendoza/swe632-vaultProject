                ...
                >
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Nav className="mr-auto">
                            ...
                            >
                                <Icon name='plus circle'/> Create New Entry
                            </Nav.Link>

                            {/* This is the "Manage Vault" Dropdown */}
                            <Dropdown as={NavItem}>
                                <Dropdown.Toggle as={NavLink}><Icon name='setting'/> Manage VAULT</Dropdown.Toggle>

                                <Dropdown.Menu>
                                    <Dropdown.Item onClick={this.handleBackupVault}>
                                        <Icon name="archive"/> Backup VAULT to File
                                    </Dropdown.Item>

                                    <Dropdown.Item onClick={this.toggleUploadPopup}>
                                        <Icon name="redo"/> Restore VAULT from File
                                    </Dropdown.Item>

                                    <Dropdown.Item onClick={this.handleDeleteAllNotes}>
                            ...
                            {/* Add Help Popup */}
                            <Nav.Link onClick={this.showHelpPopup}>
